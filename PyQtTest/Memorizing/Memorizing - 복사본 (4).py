...
class App33(QTableWidget):
    ...
    def dispTableView33(self):
        ...
        self.check1 = QCheckBox('All DB tables 검색하기  ')
        self.check2 = QCheckBox('Perfect match of Word ')
        self.check1.setChecked(True)
    ...
    def searchDB(self):
        ...
        option1 = self.check1.isChecked()        
        option2 = self.check2.isChecked()
        ...
        if not option2:  # Perfect match 가 아닌경우 키워드를 소문자로 치환
