...
import sys, os, getpass, sqlite3, re
...
from PyQt5.QtWidgets import (QApplication, QPushButton, QLabel, QTableWidget,
                            ...
                            QListView, QComboBox, QHeaderView, QAbstractItemView, QDesktopWidget,
                            QMessageBox, QTableWidgetItem, QFileDialog, QDialog, QTextEdit)
...
class QPushButton(QPushButton):
    def __init__(self, parent = None, *args):
        ...
        self.setFont(QFont('맑은 고딕', 12)) #self.setFont(QFont('Georgia', 14))
