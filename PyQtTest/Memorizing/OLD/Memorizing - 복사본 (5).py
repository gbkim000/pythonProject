...
class execute_thread(QThread):
    ...
    def run(self):
        sharedVar = True
        # self.parent.win.setWindowFlags(Qt.WindowStaysOnTopHint | Qt.FramelessWindowHint)
...
class App22(QTableWidget):
    ...
    def insertData(self):
        ...
        self.progressBar.setGeometry(15, 20, 380, 30)
        self.progressBar.setMaximum(100) 
        # self.win.setWindowFlags(Qt.WindowStaysOnTopHint) # | Qt.FramelessWindowHint)
        self.win.show()
        self.win.hide()
        
        if hasattr(self, 'worker') and isinstance(self.worker, execute_thread):
            self.worker.stop()
            
        self.worker = execute_thread(self)
        ...
        #     
        # while(1):
        #     chkWorker = hasattr(self, 'worker') and isinstance(self.worker, execute_thread)
        #     if chkWorker and self.worker.isRunning():
        #         continue
        # time.sleep(5)
