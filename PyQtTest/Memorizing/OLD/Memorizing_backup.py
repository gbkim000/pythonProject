...
[ ] 버튼이미지 추가/수정
[ ] 시작폴더 path.txt 없을 때 처리??
[ ] prpgressBar 수정
[ ] book mark 추가 후 리스트 요소 수정
[ ] saveData 함수 thread 처리
[ ] 파일/폴더 정리

'''
import sys, os, getpass, sqlite3, openpyxl, re, time, threading
...
from PyQt5.QtWidgets import (QApplication, QMainWindow, QPushButton, QLabel, QTableWidget,
            ...
            QMessageBox, QTableWidgetItem, QFileDialog, QDialog, QWidget, QTextEdit, QInputDialog)
...
class MainWindow(QMainWindow):
    ...
    def toolBarMenu(self):
        ...
        # ----- toolBar 설정하기 --------------------------------------------
        toolBtn1 = QAction(QIcon(self.imgDir + "toolBtn8.png"), 'This is your button1', self)
        toolBtn1.setStatusTip("This is your button1")
        toolBtn1.setShortcut('Ctrl+Q')

        toolBtn2 = QAction(QIcon(self.imgDir + "toolBtn9.png"), 'This is your button2', self)
        toolBtn2.setStatusTip("This is your button2")
        
        toolBtn3 = QAction(QIcon(self.imgDir + "toolBtn13.png"), 'This is your button3', self)
        toolBtn3.setStatusTip("This is your button3")

        toolBtn4 = QAction(QIcon(self.imgDir + "toolBtn14.png"), 'This is your button4', self)
        toolBtn4.setStatusTip("This is your button3")
        
        toolBtn5 = QAction(QIcon(self.imgDir + "toolBtn15.png"), 'Exit program button5', self)
        ...
        toolBtn4.triggered.connect(self.call_exitMenu)
    ...
    def call_menu21(self):
        ...
        self.app21.show()        
        # self.showMinimized()        
        # os.system("python subQMenu21.py")
        # os.system("start /d C:\\Users\\Administrator\\PyQtTest\\Memorizing /min Python.exe subQMenu21.py")
        # subprocess.call("subQMenu21.py", shell=True)    

    def call_menu22(self):
        # self.hide()
        # os.system("python subQMenu22.py")
        # self.show() 
        self.hide() 
...
#         self.progress.setValue(progVal)
#         time.sleep(0.05)
#         # self.win.update()
#         # self.update()
...
class App22(QTableWidget):
    ...
    def insertData(self):
        ...
        self.worker.finished.connect(self.finishThresh)
        self.worker.start()
            
    def finishThresh(self):
        self.win.close()
        dispData(self)
        self.saveFlag = False
    ...
    def finish(self):
        ...
        if self.saveFlag:
            ...
            #     if isinstance(self.worker, Worker) and self.worker.isRunning():
            #         self.worker.quit()
            #         self.worker.stop()   
