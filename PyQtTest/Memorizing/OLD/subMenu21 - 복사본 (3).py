...
stylesheetBtn = ("QPushButton{background-color: rgb(0, 50, 180); "
                  ...
                  "QPushButton::pressed {background-color: #FF9900;}") #" 142090;}")
    ...
    def dispData1(self):
        ...
        try:
            ...
            for row in range(rows):
                ...
                itm4 = QTableWidgetItem(lst[row][4])
                itm5 = QTableWidgetItem(lst[row][5])
    ...
    def dispData(self):
        ...
        try:
            ...
            while query.next():
                ...
                itm4 = QTableWidgetItem(query.value(4))
                itm5 = QTableWidgetItem(query.value(5))
                ...
                self.view.setItem(rows, 0, itm1)
                self.view.setItem(rows, 1, itm2)
                self.view.setItem(rows, 2, itm3)
                self.view.setItem(rows, 3, itm4)
                self.view.setItem(rows, 4, itm5)
