...
def drawBorder():
    ...
    resetButtonInnerRect = pygame.Rect(GAMEWINDOWWIDTH / 2 - (MONITORHEIGHT) / 2 + 4, CELLSIZE + 4, MONITORHEIGHT - 8,
                                       MONITORHEIGHT - 8)
...
def showLevelScreen():
    while True:
        ...
        intermediateLineRect = pygame.Rect(intermediateRect.x - 4, intermediateRect.y - 4, intermediateRect.w + 8,
                                           intermediateRect.h + 8)
...
def showCustomScreen(customRect):
    ...
    customWTBoxLineRect = pygame.Rect(customWTBoxRect.x - 4, customWTBoxRect.y - 4, customWTBoxRect.w + 8,
                                      customWTBoxRect.h + 8)
    ...
    customHTBoxLineRect = pygame.Rect(customHTBoxRect.x - 4, customHTBoxRect.y - 4, customHTBoxRect.w + 8,
                                      customHTBoxRect.h + 8)
    ...
    customPTBoxLineRect = pygame.Rect(customPTBoxRect.x - 4, customPTBoxRect.y - 4, customPTBoxRect.w + 8,
                                      customPTBoxRect.h + 8)
    ...
    customButtonLineRect = pygame.Rect(customButtonRect.x - 4, customButtonRect.y - 4, customButtonRect.w + 8,
                                       customButtonRect.h + 8)
    ...
    customBackLineRect = pygame.Rect(customBackRect.x - 4, customBackRect.y - 4, customBackRect.w + 8,
                                     customBackRect.h + 8)
